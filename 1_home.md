...
<div style="background: #8b7da7;">
  <p style="background: #20a5de; font-weight: 300; color: #fff; padding: 15px 0; font-size: 20px;"><span style="font-weight: 400;">Start Date:</span> 6/6 | <span style="font-weight: 400;">End Date:</span> 6/27</p>
</div>
...
<div style="width: 100%; clear: both; float: left; padding-top: 40px; padding-bottom: 40px;">
  <div style="width: 85%; margin: auto;">
    ...
    <div style="padding-left: 20px;float:left; width: 50%;">
      <img style="border-radius: 50%; width: 100px; float:left;" src="https://wwwstatic-d.lookercdn.com/people/team/shana_cohen_v0002.png">
      <div style="float:left; text-align: left; padding-left: 15px; padding-top: 15px;">
        ...
        <span style="font-weight: 300;">Shana Cohen<br>
        shana@looker.com</span></p>
      </div>
    </div>

    <div style="padding-left: 40px;float:left; width: 50%;">
      <img style="border-radius: 50%; width: 100px; float:left;" src="https://wwwstatic-b.lookercdn.com/people/team/skander_larbi_v0001.jpg">
      <div style="float:left; text-align: left; padding-left: 15px; padding-top: 15px;">
        <p><span style="font-size: 16px;">Analyst</span><br>
        <span style="font-weight: 300;">Skander Larbi<br>
        skander@looker.com</span></p>
      </div>
    </div>
